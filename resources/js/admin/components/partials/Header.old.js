...
const Header = (props) => {
    ...
    <ul className="navbar-nav ml-auto">
      ...
      <li className="nav-item dropdown show">
        ...
        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right show" style="left: inherit; right: 0px;">
      ...
      <li className="nav-item">
        <a className="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button"><i className="fas fa-th-large"></i></a>
      </li>
    </ul>
  </nav>
